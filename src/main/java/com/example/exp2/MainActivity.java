...
public class MainActivity extends AppCompatActivity {
    ...
    private int flag = 0;//横竖屏指示flag，用于列表显示

    private List<Words> wordsList = new ArrayList<>();//单词表
    ...
    public void initWords() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                @SuppressLint("Range") String meanings = cursor.getString(cursor.getColumnIndex("meanings"));
                @SuppressLint("Range") String exS = cursor.getString(cursor.getColumnIndex("exampleSentence"));
                //创建一个单词，并初始化
